...
#r=requests.get("https://pub.orcid.org/v3.0/0000-0003-2293-4712/works", params={}, headers={"Accept":"application/json"})
...
#file = open("orcid-search.json", "wb")
#file.write(r.content)
#file.close()

f = open("orcid-search.json")
data = json.load(f)
for i in data['expanded-result']:
    if (i['institution-name']):
        print (i['orcid-id'])
        print (i['given-names'])
        print (i['family-names'])
        print (i['institution-name'][0])